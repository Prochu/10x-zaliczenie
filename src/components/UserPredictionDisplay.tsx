...
interface UserPredictionDisplayProps {
  ...
  match: Pick<
    ...
    "homeTeamName" | "awayTeamName" | "homeTeamLogo" | "awayTeamLogo" | "finalHomeScore" | "finalAwayScore"
  >;
}
...
export const UserPredictionDisplay: React.FC<UserPredictionDisplayProps> = ({ prediction, match }) => {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className={`rounded-lg border p-3 ${isCorrect ? "bg-green-50 border-green-200" : "bg-muted/30"}`}>
        <TeamScoreDisplay
          homeTeam={{
